...
def main():
	...
	# for i in range(100):
		...
		print(value)
		if kernel_RBF(X, Y, 1.5) != -1 and value != -1:
			if kernel_RBF(X, Y, 1.5) < value:
				count += 1
			i += 1
		# if kernel_RBF(X, Y, 1.5) < value:
		# 	count += 1
	...
	# for i in range(100):
		X, Y = gen_points(100)
		value2 = reg_RBF(X, Y, 1.5, 1, 12)
		print(value2)
		if kernel_RBF(X, Y, 1.5) != -1 and value2 != -1:
			if kernel_RBF(X, Y, 1.5) < value2:
		# if kernel_RBF(X, Y, 1.5) < value2:
				count += 1
			i += 1
	print("K=12:", count)
	...
	# for i in range(100):
	# 	X, Y = gen_points(100)
	# 	print(reg_RBF(X, Y, 1.5, 1, 9), reg_RBF(X, Y, 1.5, 1, 12))
